...
class FrontendStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str) -> None:
        ...
        imageAsset = DockerImageAsset(self, "FrontendStreamlitImage",
            ...
            directory=("streamlit_serverless_app/websockets_server/")
        )
        ...
        fargate_service.service.connections.security_groups[0].add_ingress_rule(
            ...
            description="Allow ALB health check traffic inbound"
        )
        
        # Add egress rule for health check port
        fargate_service.load_balancer.connections.security_groups[0].add_egress_rule(
            peer=fargate_service.service.connections.security_groups[0],
            connection=ec2.Port.tcp(8080),
            description="Allow ALB health check traffic outbound"
        )
